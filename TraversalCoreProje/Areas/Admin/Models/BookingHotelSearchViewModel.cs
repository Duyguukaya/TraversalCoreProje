namespace TraversalCoreProje.Areas.Admin.Models
{
    public class BookingHotelSearchViewModel
    {
        ...
        public class Result
        {
            ...
            public object crib_guaranteed { get; set; }
        ...
        public class Price_Breakdown
        {
            ...
            public object has_fine_print_charges { get; set; }
            public object has_incalculable_charges { get; set; }
            public object all_inclusive_price { get; set; }
            public object currency { get; set; }
            public object has_tax_exceptions { get; set; }
