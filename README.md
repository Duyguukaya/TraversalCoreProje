...
### Gereksinimler
- [.NET SDK](https://dotnet.microsoft.com/download) (6.0 veya üzeri)
- [SQL Server](https://www.microsoft.com/tr-tr/sql-server) (LocalDB veya tam sürüm)
- [Visual Studio 2022](https://visualstudio.microsoft.com/tr/) veya [VS Code](https://code.visualstudio.com/)

### Adımlar

```bash
# 1. Repoyu klonlayın
git clone https://github.com/Duyguukaya/TraversalCoreProje.git
cd TraversalCoreProje

# 2. Bağlantı dizesini güncelleyin
# TraversalCoreProje/appsettings.json dosyasında:
# "ConnectionStrings": { "DefaultConnection": "Server=...;Database=TraversalDb;..." }

# 3. Veritabanını oluşturun (Package Manager Console)
Update-Database

# 4. Projeyi çalıştırın
# Visual Studio: F5 veya Ctrl+F5
# dotnet CLI:
dotnet run --project TraversalCoreProje
```

> **Not:** SignalR API projelerini (SignalRApi / SignalRApiForSql) aynı anda başlatmanız gerekebilir. Visual Studio'da birden fazla başlangıç projesi ayarlayabilirsiniz.
...
| Paket | Amaç |
| :--- | :--- |
| `Microsoft.EntityFrameworkCore` | ORM ve veritabanı işlemleri |
| `Microsoft.AspNetCore.Identity` | Kimlik doğrulama ve yetkilendirme |
